...
const BILLSOUTPUTManagement = () => import('@/views/BILLSOUTPUTManagement')
const ChannelManagement = () => import('@/views/ChannelManagement')
const PaymentBillManagement = () => import('@/views/PaymentBillManagement')
  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: 'BillsOutput',
          name: 'BILLSOUTPUTManagement',
          component: BILLSOUTPUTManagement
        },
        {
          path: 'channel',

<template>
  <b-card no-body :header="caption">
    ...
    <nav>
      <b-pagination class="ml-3" :total-rows="totalRows" :per-page="perPage" v-model="currentPage" prev-text="Prev" next-text="Next" hide-goto-end-buttons/>
    </nav>
  </b-card>
</template>

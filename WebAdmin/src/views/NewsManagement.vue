  ...
  <div>
    ...
    <b-row v-if="!loading" class="animated fadeIn">
      <b-col :lg="12">
        ...
        <b-button class="mb-2" @click="create" variant="primary">Add new News</b-button>
      </b-col>

      <b-col :lg="current ? 6 : 12">
        <c-table :table-data="items" :fields="fields" hover caption="News" :rowClicked="rowClicked"></c-table>
      </b-col>
  ...
  data: () => {
    return {
      ...
      fields: [
        ...
        {key: 'OrganizationMemberID', sortable: true},
        {key: 'Public'},
